...
import com.unity3d.player.UnityPlayerGameActivity;  // 引入 UnityPlayerGameActivity
...
public class MainActivity extends AppCompatActivity {
    ...
    private void showGameOverDialog(int finalScore) {
        ...
        Button playAnimationButton = dialogView.findViewById(R.id.playAnimationButton);  // 正確引用 playAnimationButton
        ...
        // 設定「播動畫」按鈕的點擊事件
        playAnimationButton.setOnClickListener(v -> {
            // 跳轉到 UnityPlayerGameActivity 播放動畫
